...
export const THEMES: Record<ThemeId, ThemeConfig> = {
  ...
  pony: {
    id: 'pony',
    name: '小马宝莉',
    subtitle: '友谊就是魔法 · 学霸紫悦 (Twilight Sparkle)',
    emoji: '🦄',
    mascotName: '紫悦 (Twilight Sparkle)',
    mascotType: 'pony',
    colors: {
      ...
      orpColor: '#C026D3', // Fuchsia 600 - Twilight's magic star color
      navBg: 'bg-white/85 border-purple-200',
      progressBar: 'from-purple-500 via-fuchsia-400 to-pink-400',
  ...
  eggy: {
    id: 'eggy',
    name: '蛋仔派对',
    subtitle: '搞快点搞快点 · 蛋小黄经典派对 (Eggy Party)',
    emoji: '🍳',
